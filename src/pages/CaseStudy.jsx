      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block px-3 py-1 bg-neon-blue/10 border border-neon-blue/30 rounded mb-4">
                <span className="text-sm text-neon-blue font-medium">CASE STUDY: E-COMMERCE</span>
              </div>
              <h1 className="text-5xl sm:text-6xl font-bold mb-6">
                NexGen <span className="text-neon-blue">E-Commerce</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="flex items-center gap-2 px-6 py-3 bg-neon-blue text-white rounded font-medium hover:opacity-90 transition-colors">
                  View Live Site
                  <HiArrowTopRightOnSquare className="h-5 w-5" />
                </button>
                <button className="px-6 py-3 border border-neon-blue text-white rounded font-medium hover:bg-neon-blue/10 transition-colors">
                  Client Interview
                </button>
              </div>
            </div>
            <div className="relative">
              <div className="bg-brand-card border border-brand-border rounded p-8">
                <div className="aspect-video bg-gradient-to-br from-neon-blue/20 to-transparent rounded flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-24 h-24 bg-neon-blue/20 rounded mx-auto mb-4 flex items-center justify-center">
                      <HiBolt className="h-12 w-12 text-neon-blue" />
                    </div>
        ...
        <section className="mb-20 grid md:grid-cols-2 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <HiBolt className="h-5 w-5 text-neon-blue" />
        ...
        <section className="mb-20">
          ...
          <div className="w-24 h-1 bg-neon-blue mb-8" />
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <FaReact className="h-8 w-8 text-neon-blue mx-auto mb-3" />
              <p className="text-white font-medium">React / Next.js</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <SiGraphql className="h-8 w-8 text-neon-blue mx-auto mb-3" />
              <p className="text-white font-medium">GraphQL</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <SiAws className="h-8 w-8 text-neon-blue mx-auto mb-3" />
              <p className="text-white font-medium">AWS Lambda</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <HiBolt className="h-8 w-8 text-neon-blue mx-auto mb-3" />
        ...
        {/* Development Journey */}
        <section className="mb-20">
          <h2 className="text-4xl font-bold text-white mb-4">Development Journey</h2>
          <div className="w-24 h-1 bg-neon-blue mb-8" />
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-neon-blue/30" />
            <div className="space-y-12">
              {[
                ...
                <div key={index} className="flex gap-6">
                  <div className="flex-shrink-0 w-16 h-16 bg-neon-blue rounded flex items-center justify-center text-white font-bold text-xl">
                    {step.number}
                  </div>
                  <div>
        ...
        <section className="grid md:grid-cols-2 gap-8 mb-20">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <p className="text-4xl font-bold text-neon-blue mb-2">150%</p>
              <p className="text-sm text-gray-400">SPEED INCREASE</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <p className="text-4xl font-bold text-neon-blue mb-2">22%</p>
              <p className="text-sm text-gray-400">CONVERSION BOOST</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <p className="text-4xl font-bold text-neon-blue mb-2">0.8s</p>
              <p className="text-sm text-gray-400">AVG. PAGE LOAD</p>
            </div>
            <div className="bg-brand-card border border-neon-blue/30 rounded p-6 text-center">
              <p className="text-4xl font-bold text-neon-blue mb-2">99.9%</p>
              <p className="text-sm text-gray-400">UPTIME RELIABILITY</p>
            </div>
          </div>
          <div className="bg-neon-blue rounded p-8">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">CTO, NexGen Retail</p>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-brand-border pt-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Link
              to="/contact"
              className="px-6 py-3 bg-neon-blue text-white rounded font-medium hover:opacity-90 transition-colors"
            >
              Get in Touch
            </Link>
          </div>
